                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6" style="width: 100%; margin: 0 auto">
                                    <%--表单--%>
                                    <form role="form" action="${pageContext.request.contextPath}/updateMember"
                                        ...
                                        <div class="form-group">
                                            <label>成员编号</label>
                                            <input class="form-control" name="membersId" value="${requestScope.updateMember.membersId}">
                                        </div>
                                        <div class="form-group">
                                            <label>成员名称</label>
                                            <input class="form-control" name="membersName" value="${requestScope.updateMember.membersName}">
                                        </div>
                                        <div class="form-group">
                                            <label>成员与家主关系</label>
                                            <input class="form-control" name="membersRelation" value="${requestScope.updateMember.membersRelation}">
                                        </div>
