            ...
            <ul class="nav" id="main-menu">
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="active-menu" href="${pageContext.request.contextPath}/pre_list">收入表</a>
                        </li>
                        <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                    ...
                                    <tbody>
                                    <c:if test="${requestScope.incomeEntityList!=null}">
                                        <c:forEach items="${requestScope.incomeEntityList}" var="incomeEntity">
                                            <tr class="gradeA">
                                                <td><fmt:formatDate value="${incomeEntity.incomeTime}"
                                                                    pattern="yyyy-MM-dd"/></td>
                                                <td>${incomeEntity.incomeMemberid}</td>
                                                <td>${incomeEntity.incomeAmount}</td>
                                                <td>${incomeEntity.incomeKind}</td>
                                                <td>
                                                    <ul class="actions">
                                                        <li><a href="${pageContext.request.contextPath}/delIncome?incomeId=${incomeEntity.incomeId}&usersId=<%=usersId%>" onclick="return del()"><i class="table-delete" title="删除"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </c:forEach>
