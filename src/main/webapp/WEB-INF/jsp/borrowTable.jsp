            ...
            <ul class="nav" id="main-menu">
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="${pageContext.request.contextPath}/pre_list?type=borrow">债务表</a>
                        </li>
                        <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example3">
                                    ...
                                    <tbody>
                                    <c:if test="${requestScope.borrowEntityList!=null}">
                                        <c:forEach items="${requestScope.borrowEntityList}" var="borrowEntity">
                                            <tr class="gradeA">
                                                <td><fmt:formatDate value="${borrowEntity.borrowTime}"
                                                                    pattern="yyyy-MM-dd"/></td>
                                                <td>${borrowEntity.borrowMemberid}</td>
                                                <td>${borrowEntity.borrowAmount}</td>
                                                <td>${borrowEntity.borrowName}</td>
                                                <td>
                                                    <ul class="actions">
                                                        <li><a href="${pageContext.request.contextPath}/delBorrow?borrowId=${borrowEntity.borrowId}&usersId=<%=usersId%>" onclick="return del()"><i class="table-delete" title="删除"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </c:forEach>
