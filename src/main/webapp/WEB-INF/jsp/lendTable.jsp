            ...
            <ul class="nav" id="main-menu">
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="${pageContext.request.contextPath}/pre_list?type=lend">债权表</a>
                        </li>
                        <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example4">
                                    ...
                                    <tbody>
                                    <c:if test="${requestScope.lendEntityList!=null}">
                                        <c:forEach items="${requestScope.lendEntityList}" var="lendEntity">
                                            <tr class="gradeA">
                                                <td><fmt:formatDate value="${lendEntity.lendTime}"
                                                                    pattern="yyyy-MM-dd"/></td>
                                                <td>${lendEntity.lendMemberid}</td>
                                                <td>${lendEntity.lendAmount}</td>
                                                <td>${lendEntity.lendName}</td>
                                                <td>
                                                    <ul class="actions">
                                                        <li><a href="${pageContext.request.contextPath}/delLend?lendId=${lendEntity.lendId}&usersId=<%=usersId%>" onclick="return del()"><i class="table-delete" title="删除"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
